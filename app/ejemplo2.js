...
.then(async () => {
    ...
    await madridCentral.addResident(1000, "Rodri", "r@r", "passord", 666778899, 10, {from: accounts[1], gas: 5000000, gasPrice: '30000000'});
    await madridCentral.addResident(1000, "Rodri", "r@r", "passord", 666778899, 10, {from: accounts[2], gas: 5000000, gasPrice: '30000000'});
    await madridCentral.addResident(1000, "Rodri", "r@r", "passord", 666778899, 10, {from: accounts[3], gas: 5000000, gasPrice: '30000000'});
    ...
    await madridCentral.addResident(1000, "Rodri", "r@r", "passord", 666778899, 10, {from: accounts[4], gas: 5000000, gasPrice: '300000000'});
    ...
    await madridCentral.getInvitation(2, "1234GGG", {from: accounts[5], gas: 50000000, gasPrice: '300000'});
    await madridCentral.getInvitation(2, "1234HHH", {from: accounts[10], gas: 50000000, gasPrice: '300000'});
    ...
    const invitationOfDay1 = await madridCentral.getInvitationFromDay(2, {from: accounts[6], gas: 50000000, gasPrice: '300000'});
    console.log(invitationOfDay1);
